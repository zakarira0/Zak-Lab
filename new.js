...
function renderAllEquipment() {
    ...
    // تنظيف الحاوية قبل إعادة الرسم
    container.innerHTML = '';

    if (typeof equipmentCatalog !== 'undefined' && Array.isArray(equipmentCatalog)) {
        equipmentCatalog.forEach(function (entry) {
            if (!entry || !entry.data) {
                return;
            }
            renderEquipmentCard(entry.data, {
                id: entry.cardId || ('equipment-' + (entry.data.id || 'item')),
    ...
    if (typeof microscopeData !== 'undefined') {

        renderEquipmentCard(microscopeData, {

            id: 'microscope-card-item',
    ...
    if (typeof hematologyData !== 'undefined') {

        renderEquipmentCard(hematologyData, {

            id: 'hematology-card-item',
    ...
    if (typeof centrifugeData !== 'undefined') {

        renderEquipmentCard(centrifugeData, {

            id: 'centrifuge-card-item',
    ...
    if (typeof autoclaveData !== 'undefined') {

        renderEquipmentCard(autoclaveData, {

            id: 'autoclave-card-item',
    ...
    if (typeof incubatorData !== 'undefined') {

        renderEquipmentCard(incubatorData, {

            id: 'incubator-card-item',
    ...
    if (typeof ovenData !== 'undefined') {

        renderEquipmentCard(ovenData, {
    ...
    if (typeof cliaData !== 'undefined') {

        renderEquipmentCard(cliaData, {
    ...
    if (typeof afias6Data !== 'undefined') {

        renderEquipmentCard(afias6Data, {

            id: 'afias-6-card-item',
    ...
    if (typeof fujiData !== 'undefined') {

        renderEquipmentCard(fujiData, {
    ...
    if (typeof cobasData !== 'undefined') {

        renderEquipmentCard(cobasData, {
    ...
    if (typeof finecareData !== 'undefined') {

        renderEquipmentCard(finecareData, {

            id: 'finecare-card-item',
    ...
    if (typeof fincubatorData !== 'undefined') {

        renderEquipmentCard(fincubatorData, {

            id: 'fincubator-card-item',
    ...
    if (typeof spectrophotometerData !== 'undefined') {

        renderEquipmentCard(spectrophotometerData, {

            id: 'spectrophotometer-card-item',
    ...
    if (typeof microhematocritData !== 'undefined') {

        renderEquipmentCard(microhematocritData, {

            id: 'microhematocrit-card-item',
    ...
    if (typeof shakerData !== 'undefined') {

        renderEquipmentCard(shakerData, {
    ...
    if (typeof elisaReaderData !== 'undefined') {

        renderEquipmentCard(elisaReaderData, {

            id: 'elisa-reader-card-item',
    ...
    if (typeof pcrThermalCyclerData !== 'undefined') {

        renderEquipmentCard(pcrThermalCyclerData, {

            id: 'pcr-thermal-cycler-card-item',
    ...
    // ========================================================
    // ⚖️ Laboratory Balance
    // ========================================================

    if (typeof balanceData !== 'undefined') {

        renderEquipmentCard(balanceData, {

            id: 'balance-card-item',
    ...
    if (typeof micropipetteData !== 'undefined') {

        renderEquipmentCard(micropipetteData, {

            id: 'micropipette-card-item',
...
function renderLabTools() {
    ...
    if (typeof labToolsData === 'undefined' || !Array.isArray(labToolsData)) {
        return;
    }

    labToolsData.forEach(function (tool) {
        renderEquipmentCard(tool, {
            id: 'lab-tool-' + tool.id,
            containerId: 'lab-tools-container',
            badges: [
                tool.category || 'Lab Tool',
                'Practical Skills'
            ]
        });
    });
...
(function () {
    ...
    function getSearchSources() {
        const builtInSources = [
            ...
            { key: 'equipment', label: '🔬 الأجهزة', pageId: 'equipment-page', containerId: 'equipment-container', equipment: true, equipmentTab: 'devices', getData: function () { return typeof equipmentCatalog !== 'undefined' && Array.isArray(equipmentCatalog) ? equipmentCatalog.map(function (entry) { return entry && entry.data; }).filter(Boolean) : []; } },
            { key: 'lab-tools', label: '🧰 الأدوات المختبرية', pageId: 'equipment-page', containerId: 'lab-tools-container', equipmentTab: 'tools', getData: function () { return typeof labToolsData !== 'undefined' ? labToolsData : []; } },
    ...
    function renderResults(results, query) {
        ...
        resultsContainer.hidden = false;
        resultsContainer.querySelectorAll('[data-result-id]').forEach(function (button) {
            button.addEventListener('click', function () {
